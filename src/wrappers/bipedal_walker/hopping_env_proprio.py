...
class ProprioHopReward(HopReward):
    """
    Extends HopReward by stripping the 10 lidar rays from the observation.
    ...
    def __init__(self, env, **kwargs):
        ...
        # HopReward already built a 25-dim Box. Rebuild it as 15-dim
        base = self.observation_space  # the 25-dim Box from HopReward
    ...
    def _strip_lidar(obs: np.ndarray) -> np.ndarray:
        # obs is 25-dim from HopReward: proprio | lidar | cmd_vel
